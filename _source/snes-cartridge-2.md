...
I managed to find an old "standard" edge connector with 2*23 pins (just like a SNES cartridge with no extension chips). I found it at the physical store [Tema Elektronik](http://www.temaelektronik.se) here in Gothenburg. It is the only physical store that I know of that sells electronics stuff since ELFA closed (Kjell&co does have some stuff and they are super helpful, but still).

Here it is in all its glory:

![Standard edge connector](images/edgecon.jpg)
![Standard edge connector](images/edgecon2.jpg)

When mounted on a game it looks like this:

![Mounted on SNES cartridge](images/edgecon_mounted.jpg)
...
![40-pin cable with male-female-connectors](images/cable-40p-male-female.jpg)
...
I also found some information on [SNES Cartridges](http://www.cs.umb.edu/~bazz/snes/cartridges/) here. Especially [this](http://www.cs.umb.edu/~bazz/snes/cartridges/electronics/simple_components.html), [this](http://www.cs.umb.edu/~bazz/snes/cartridges/electronics/speeds.html) and [this](http://www.cs.umb.edu/~bazz/snes/cartridges/lorom.html) seems helpful. I will probably learn a lot from these.
